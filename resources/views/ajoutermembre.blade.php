...
<section id="basic-vertical-layouts">
                    <div class="row match-height">
                        ...
                        <div class="card">
                            ...
                            <h4 class="card-title">Ajouter Membre Associé</h4>
                            </div>
                            <div class="card-content">
                            <div class="card-body">
                                <form name="form" action="{{ route('membres.store') }}" method="post" onsubmit="return validation_email()" class="form form-vertical" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                    <div class="col-12">
